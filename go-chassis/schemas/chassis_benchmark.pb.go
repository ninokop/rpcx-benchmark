...
// source: chassis_benchmark.proto

/*
	Package main is a generated protocol buffer package.

	It is generated from these files:
		chassis_benchmark.proto
...
func (*BenchmarkMessage) Descriptor() ([]byte, []int) { return fileDescriptorChassisBenchmark, []int{0} }
...
func (m *BenchmarkMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(m.Field1)))
	i += copy(dAtA[i:], m.Field1)
	dAtA[i] = 0x10
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(m.Field2))
	dAtA[i] = 0x18
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(m.Field3))
	dAtA[i] = 0x22
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(m.Field4)))
	...
	if m.Field6 != nil {
		dAtA[i] = 0x30
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field6))
	}
	dAtA[i] = 0x3a
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(m.Field7)))
	i += copy(dAtA[i:], m.Field7)
	dAtA[i] = 0x4a
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(m.Field9)))
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(m.Field16))
	if m.Field17 != nil {
		dAtA[i] = 0x88
		i++
		dAtA[i] = 0x1
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(m.Field18)))
	i += copy(dAtA[i:], m.Field18)
	dAtA[i] = 0xb0
	i++
	dAtA[i] = 0x1
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(m.Field22))
	if m.Field23 != nil {
		dAtA[i] = 0xb8
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field23))
	}
	if m.Field24 != nil {
		dAtA[i] = 0xc0
		i++
	...
	if m.Field25 != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field25))
	}
	if m.Field29 != nil {
		dAtA[i] = 0xe8
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field29))
	}
	if m.Field30 != nil {
		dAtA[i] = 0xf0
		i++
	...
	if m.Field60 != nil {
		...
		dAtA[i] = 0x3
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field60))
	}
	if m.Field67 != nil {
		dAtA[i] = 0x98
		i++
		dAtA[i] = 0x4
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field67))
	}
	dAtA[i] = 0xa0
	i++
	dAtA[i] = 0x4
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(m.Field68))
	dAtA[i] = 0xf0
	i++
	dAtA[i] = 0x4
	i++
	...
	if m.Field100 != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field100))
	}
	if m.Field101 != nil {
		dAtA[i] = 0xa8
		i++
		dAtA[i] = 0x6
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field101))
	}
	dAtA[i] = 0xb2
	i++
	dAtA[i] = 0x6
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(m.Field102)))
	i += copy(dAtA[i:], m.Field102)
	dAtA[i] = 0xba
	i++
	dAtA[i] = 0x6
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(m.Field103)))
	...
	if m.Field104 != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field104))
	}
	if m.Field128 != nil {
		dAtA[i] = 0x80
		i++
		dAtA[i] = 0x8
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field128))
	}
	if m.Field129 != nil {
		dAtA[i] = 0x8a
		i++
		dAtA[i] = 0x8
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(len(*m.Field129)))
	...
	if m.Field130 != nil {
		...
		dAtA[i] = 0x8
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field130))
	}
	if m.Field131 != nil {
		dAtA[i] = 0x98
		i++
		dAtA[i] = 0x8
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field131))
	}
	dAtA[i] = 0xb0
	i++
	dAtA[i] = 0x9
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(m.Field150))
	if m.Field271 != nil {
		dAtA[i] = 0xf8
		i++
		dAtA[i] = 0x10
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field271))
	}
	if m.Field272 != nil {
		dAtA[i] = 0x80
		i++
		dAtA[i] = 0x11
		i++
		i = encodeVarintChassisBenchmark(dAtA, i, uint64(*m.Field272))
	}
	dAtA[i] = 0xc0
	i++
	dAtA[i] = 0x11
	i++
	i = encodeVarintChassisBenchmark(dAtA, i, uint64(m.Field280))
	return i, nil
}

func encodeVarintChassisBenchmark(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *BenchmarkMessage) Size() (n int) {
	...
	_ = l
	l = len(m.Field1)
	n += 1 + l + sovChassisBenchmark(uint64(l))
	n += 1 + sovChassisBenchmark(uint64(m.Field2))
	n += 1 + sovChassisBenchmark(uint64(m.Field3))
	l = len(m.Field4)
	n += 1 + l + sovChassisBenchmark(uint64(l))
	if len(m.Field5) > 0 {
		n += 9 * len(m.Field5)
	...
	if m.Field6 != nil {
		n += 1 + sovChassisBenchmark(uint64(*m.Field6))
	}
	l = len(m.Field7)
	n += 1 + l + sovChassisBenchmark(uint64(l))
	l = len(m.Field9)
	...
	n += 2 + sovChassisBenchmark(uint64(m.Field16))
	if m.Field17 != nil {
		n += 3
	}
	l = len(m.Field18)
	n += 2 + l + sovChassisBenchmark(uint64(l))
	n += 2 + sovChassisBenchmark(uint64(m.Field22))
	if m.Field23 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field23))
	}
	if m.Field24 != nil {
		n += 3
	}
	if m.Field25 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field25))
	}
	if m.Field29 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field29))
	}
	if m.Field30 != nil {
		n += 3
	}
	...
	if m.Field60 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field60))
	}
	if m.Field67 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field67))
	}
	n += 2 + sovChassisBenchmark(uint64(m.Field68))
	n += 3
	if m.Field80 != nil {
		n += 3
	}
	...
	if m.Field100 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field100))
	}
	if m.Field101 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field101))
	}
	l = len(m.Field102)
	n += 2 + l + sovChassisBenchmark(uint64(l))
	l = len(m.Field103)
	n += 2 + l + sovChassisBenchmark(uint64(l))
	if m.Field104 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field104))
	}
	if m.Field128 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field128))
	}
	if m.Field129 != nil {
		l = len(*m.Field129)
		n += 2 + l + sovChassisBenchmark(uint64(l))
	...
	if m.Field130 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field130))
	}
	if m.Field131 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field131))
	}
	n += 2 + sovChassisBenchmark(uint64(m.Field150))
	if m.Field271 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field271))
	}
	if m.Field272 != nil {
		n += 2 + sovChassisBenchmark(uint64(*m.Field272))
	}
	n += 2 + sovChassisBenchmark(uint64(m.Field280))
	return n
}

func sovChassisBenchmark(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozChassisBenchmark(x uint64) (n int) {
	return sovChassisBenchmark(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *BenchmarkMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowChassisBenchmark
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthChassisBenchmark
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipChassisBenchmark(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipChassisBenchmark(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowChassisBenchmark
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthChassisBenchmark
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipChassisBenchmark(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthChassisBenchmark = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowChassisBenchmark   = fmt.Errorf("proto: integer overflow")
)

func init() { proto.RegisterFile("chassis_benchmark.proto", fileDescriptorChassisBenchmark) }

var fileDescriptorChassisBenchmark = []byte{
	// 507 bytes of a gzipped FileDescriptorProto
	,
}
